...
namespace Lidgren.Network
{
	...
	public partial class NetPeer
	{
		...
		private void HandleReleasedFragment(NetIncomingMessage im)
		{
			...
			LogWarning("FRAG: Received fragment " + chunkNumber + " of " + totalNumChunks + " (group " + group + ", " + cnt + " chunks received, totalBytes=" + totalBytes + ")");
			...
			if (info.ReceivedChunks.Count() == totalNumChunks)
			{
				...
				LogWarning("FRAG: Group #" + group + " fully received in " + totalNumChunks + " chunks (" + totalBits + " bits)");
				groups.Remove(group);
